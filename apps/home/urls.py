...
urlpatterns = [
    ...
    path('dashboard/acheteur/wallet/',       views.dashboard_acheteur_wallet,    name='dashboard_acheteur_wallet'),
    ...
    path('dashboard/producteur/wallet/',          views.dashboard_producteur_wallet,      name='dashboard_producteur_wallet'),
    ...
    path('dashboard/superadmin/pos/',                views.dashboard_superadmin_pos,               name='dashboard_superadmin_pos'),
